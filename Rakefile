...
begin
  ...
  Jeweler::Tasks.new do |gem|
    ...
    gem.description = %Q{A software model in Ruby for the greenhouse gas emissions of an pet}
    gem.email = "andy@rossmeissl.net"
    gem.homepage = "http://github.com/brighterplanet/pet"
